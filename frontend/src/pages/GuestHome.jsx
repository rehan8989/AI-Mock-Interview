import { BrainCircuit, Clock3, FileSearch } from "lucide-react";
        ...
        <section className="mx-auto max-w-7xl px-6 pb-20 lg:px-10">
          <div className="mb-10 text-center">
            ...
            <p className="mx-auto mt-3 max-w-2xl text-gray-500">
              MockAI is designed to help you practice, evaluate and improve so
              you can perform your best in real interviews.
            </p>
          </div>
