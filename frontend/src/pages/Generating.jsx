...
function Generating() {
  ...
  const jobDescription = location.state?.jobDescription?.trim();
  ...
  useEffect(() => {
    ...
    const generate = async () => {
      try {
        ...
        const result = await generateInterview(jobDescription);

        console.log("Interview generated:", result);

        // -----------------------------------------
        // Validate response
        // -----------------------------------------

        if (!result || !result.success || !result.interview) {
          throw new Error("Interview generation returned an invalid response.");
        }
        ...
        console.log("Generated interview:", result.interview);
        ...
        setError("We couldn't generate your interview. Please try again.");
      }
    };
        ...
        <div className="flex w-full max-w-2xl flex-1 flex-col items-center justify-center text-center">
          {error ? (
            ...
            <>
              ...
              <p className="mt-3 max-w-md text-sm leading-6 text-gray-500">
                We're analyzing the job description and preparing the best
                questions for you.
              </p>
